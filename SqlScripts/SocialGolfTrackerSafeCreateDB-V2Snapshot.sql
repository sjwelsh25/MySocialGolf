...
(
  SELECT TestName = 'GetUser', HttpVerb = 'GET', TestUrl = 'api/users/2', TestInputJson = '', CreatedById = dbo.fnGetCurrentUserId(), CreatedDateTime = GETDATE()
  UNION ALL 
  SELECT TestName = 'GetAllUsers', HttpVerb = 'GET', TestUrl = 'api/users', TestInputJson = '', CreatedById = dbo.fnGetCurrentUserId(), CreatedDateTime = GETDATE()
  UNION ALL 
  SELECT TestName = 'AddUser', HttpVerb = 'POST', TestUrl = 'api/users', TestInputJson = '{ Surname = "Welsh", FirstName = "Simon", Mobile = "0400925025", CurrentHandicap = 11 }', CreatedById = dbo.fnGetCurrentUserId(), CreatedDateTime = GETDATE()
  UNION ALL 
  SELECT TestName = 'DeleteUser', HttpVerb = 'DELETE', TestUrl = 'api/users/2', TestInputJson = '', CreatedById = dbo.fnGetCurrentUserId(), CreatedDateTime = GETDATE()
  UNION ALL 
  SELECT TestName = 'GetRoundsForUser', HttpVerb = 'GET', TestUrl = 'api/users/2/rounds', TestInputJson = '', CreatedById = dbo.fnGetCurrentUserId(), CreatedDateTime = GETDATE()
)
